...
class ChatModel {
    ...
    private static func checkMessageForUrl(message: String) -> Bool {
    ...
    private static func checkMessageForBlockedWords(message: String) -> String? {
        let words = message.split(separator: " ")
    ...
    func sendMessage(senderId: String, receiverId: String, content: String, chatId: String, errorSetter: @escaping (String) -> Void, messageSentSetter: @escaping () -> Void) {
        if ChatModel.checkMessageForUrl(message: content) {
            errorSetter("Sending URLs is forbidden.")
            return
        }
        
        if let blockedWord = ChatModel.checkMessageForBlockedWords(message: content) {
